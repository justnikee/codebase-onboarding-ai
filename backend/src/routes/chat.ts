 ...
 */
router.get('/suggestions/:contextId', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { contextId } = req.params;

    const suggestions = await chatService.generateSuggestedQuestions(contextId);
